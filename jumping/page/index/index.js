...
var Game = {
    ...
    loader: function(onLoad, onComplete) {
        var manifest = [
            { id: 'spriterobot', src: __uri('images/spriterobot@2x.png') },
            { id: 'spritestairs', src: __uri('images/spritestairs@2x.png') },
            { id: 'leaf_left', src: __uri('images/leaf_left@2x.png') },
            { id: 'leaf_right', src: __uri('images/leaf_right@2x.png') },
        ];
